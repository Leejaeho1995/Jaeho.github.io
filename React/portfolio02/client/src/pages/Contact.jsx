  ...
  return (
    <HelmetProvider>
      <Container>
        ...
        <Row>
          <Col lg="12">
          <Alert variant={formData.variant} className={`rounded-0 co-alert ${formData.show? "d-block":"d-none"}`}
      ...
      <hr className="t_border my-4 ml-0 text-left" />
        ...
        <Row className='mb-5 mt-3 mt-md-3'>
        <Col lg="5">
          <h3 className='py-3'>연락을 기다립니다.</h3>
          <address>
            <strong>EMAIL: </strong>
            <a href={`mailto: ${contact_config.ADMIN_EMAIL}`}>{contact_config.ADMIN_EMAIL}</a>
            <br/><br/>
            <strong>PHONE: </strong>
            <a href={`telto: ${contact_config.ADMIN_PHONE}`}>{contact_config.ADMIN_PHONE}</a>
          </address>
      ...
      <Row className='align-items-center'>
        ...
        <Col lg="6" className='form-group'>
          <input type='text' placeholder='Email' className='form-control' name='email' onChange={handleChange} value={formData.email || ""} required/>
        </Col>
